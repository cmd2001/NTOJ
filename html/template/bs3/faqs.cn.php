...
<p>  编译器版本为:<br>
  <font color=blue>g++ (GCC) 4.8.5 20150623 (Red Hat 4.8.5-28)</font>
</p>
...
3.然后就能提交评测啦！<br>
4.关于spj？首先你要先写一个NTOJ的spj，接口为argv[1,2,3]分别为输入文件，标准输出，用户输出，返回值[0,1]分别为AC,WA。然后把spj.cc和数据一起上传至数据文件夹内，最后ssh登陆服务器，<pre>cd /home/judge/data/Problem_id</pre>到数据目录，运行命令<pre>g++ spj.cc -o spj && sudo chmod 777 spj</pre>。之后就能提交评测啦！<br>
